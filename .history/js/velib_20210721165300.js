class Velib {
    constructor() {
        ...
        this.token = 'pk.eyJ1IjoicGhib3JkIiwiYSI6ImNrcmRqZWlteDBldXIzMW9lZDZudTJsNDYifQ.gUPMzLa_L-cOXy-vJ1KG4Q';
        this.zoom = 13;
        this.x = 51.505;
        this.y = -0.09;
    }
...
const token = 'pk.eyJ1IjoicGhib3JkIiwiYSI6ImNrcmRqZWlteDBldXIzMW9lZDZudTJsNDYifQ.gUPMzLa_L-cOXy-vJ1KG4Q';
const zoom = 13;
const x = 51.505;
const y = -0.09;
//let myMap = L.map('map').setView([51.505, -0.09], 13);
let myMap = L.map('map').setView([48.86, -0.09], 13);
L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
    attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors, Imagery © <a href="https://www.mapbox.com/">Mapbox</a>',
    maxZoom: 18,
    id: 'mapbox/streets-v11',
