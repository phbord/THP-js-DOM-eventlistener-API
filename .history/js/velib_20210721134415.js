        ...
        let content = `
            <div class="card" style="width: 18rem;">
                <div class="card-body">
                    ...
                    <p class="card-text">Capacité : ${data.nom_arrondissement_communes}</p>
                    <p class="card-text">Nombre de vélos disponibles : ${data.nom_arrondissement_communes}</p>
                    <p class="card-text">Nombre de docks disponibles : ${data.nom_arrondissement_communes}</p>
                </div>
            </div>
        `;
        return content;
